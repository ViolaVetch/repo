      ...
      >
        ...
        >
          <Field
            ...
            type="text"
            placeholder="Starts with 0a0853f1-X...."
            name="coinbaseApi"
          />
        </Fieldgroup>
        ...
        >
          <Field
            $variant="static"
            label="Google Tag Manager API Key*"
            type="text"
            placeholder="e.g. BgiPLXytPmkf"
            name="googleApi"
          />
        </Fieldgroup>
      </Divider>
...
export { index as NConfiguration };
